 ...
 * @author gcoutable
 */
@MutationDataFetcher(type = MutationTypeProvider.TYPE, field = MutationUpdateEdgeRoutingPointsDataFetcher.UPDATE_EDGE_ROUTING_POINTS_FIELD)
public class MutationUpdateEdgeRoutingPointsDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    public static final String UPDATE_EDGE_ROUTING_POINTS_FIELD = "updateEdgeRoutingPoints"; //$NON-NLS-1$
    ...
    public MutationUpdateEdgeRoutingPointsDataFetcher(ObjectMapper objectMapper, IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry, IGraphQLMessageService messageService) {
